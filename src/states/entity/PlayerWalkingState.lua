...
function PlayerWalkingState:update(dt)
    ...
    -- TODO: check if the collided object is a lock
    --for k, object in pairs(self.player.level.objects) do
    --    if object:collides(self.player) then
    --        if object.solid then

                -- TODO
                -- check wether the solid object is a lock
                -- need a way to distinguish wether its a lock, could be done in the GameObject class
    --            if self.player.keyFlag and object.lock then
